...
const Home = () => {
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 space-y-6 md:space-y-10 w-full">
                <div className="space-y-2 md:space-y-4">
                    <motion.h2
                        ...
                        className="text-[#6a6566] text-xl md:text-3xl font-light tracking-[0.3em] uppercase"
                    >
                        Greetings
                    </motion.h2>
                    <motion.h1
                        variants={itemVariants}
                        className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-bold text-white tracking-tighter leading-[0.9] drop-shadow-sm"
                    >
                        I'm Shreeya <br />
                ...
                <motion.p
                    variants={itemVariants}
                    className="text-[#6a6566] text-2xl md:text-4xl font-medium tracking-tight"
                >
                ...
                >
                    <a href={cvPDF} download="Shreeya_Shrestha_CV.pdf" className="w-full sm:w-auto">
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="w-full sm:w-auto bg-[#6a6566] text-white px-8 md:px-12 py-4 md:py-5 rounded-2xl text-xl md:text-2xl font-semibold transition-all duration-300 cursor-pointer shadow-2xl shadow-black/50"
                        >
                            Download CV
                        </motion.button>
                    </a>
            ...
            >
                <div className="relative group w-full max-w-[300px] sm:max-w-[400px] md:max-w-[450px]">
                    {/* Background Glows */}
                    ...
                    <motion.div
                        className="absolute -bottom-6 -left-6 md:-bottom-8 md:-left-8 bg-[#1a1a1a]/90 backdrop-blur-md p-4 md:p-8 rounded-2xl md:rounded-3xl border border-[#6a6566]/30 shadow-2xl z-20"
                        animate={{ y: [0, 15, 0], x: [0, -8, 0] }}
                        transition={{ duration: 5, repeat: Infinity, ease: "easeInOut", delay: 1 }}
                    >
                        <p className="text-white text-lg md:text-2xl font-bold tracking-tighter">Creative</p>
                        <p className="text-[#6a6566] text-[10px] md:text-sm uppercase tracking-[0.2em] font-black">UI/UX Designer</p>
                    </motion.div>
